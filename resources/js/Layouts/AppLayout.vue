...
<v-app>
    <div class="min-h-screen bg-gray-100">
        ...
        <v-navigation-drawer v-model="sidebar" app permanent>
            <v-list dense>
        ...
        <v-app-bar absolute hide-on-scroll scroll-target="#scrolling-techniques-4" app>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('company.index')" :active="route().current('company.index')">
                                Company
                            </jet-nav-link>

                            <jet-nav-link :href="route('skeleton.myself')" :active="route().current('skeleton.myself')">
                                Myself
                            </jet-nav-link>
                            ...
                            <jet-nav-link :href="route('company.type')" :active="route().current('company.type')">
                                Type
                            </jet-nav-link>
                        </div>
                    </div>
